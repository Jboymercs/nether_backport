...
import com.unseen.nb.common.blocks.base.slab.*;
...
public class ModBlocks
{
    ...
    public static final BlockSlab BLACK_STONE_SLAB_HALF = new BlockHalfSlab("black_stone_slab_half", Material.ROCK, CreativeTabs.BUILDING_BLOCKS, ModBlocks.BLACK_STONE_SLAB_HALF, STONE_HARDNESS, STONE_RESISTANCE, SoundType.STONE);
    ...
    public static final BlockSlab BLACK_BRICKS_SLAB_HALF = new BlockHalfSlab("black_bricks_slab_half", Material.ROCK, CreativeTabs.BUILDING_BLOCKS, ModBlocks.BLACK_BRICKS_SLAB_HALF, STONE_HARDNESS, STONE_RESISTANCE, SoundType.STONE);
    ...
    public static final BlockSlab POLISHED_BLACK_STONE_SLAB_HALF = new BlockHalfSlab("polished_black_stone_slab_half", Material.ROCK, CreativeTabs.BUILDING_BLOCKS, ModBlocks.POLISHED_BLACK_STONE_SLAB_HALF, STONE_HARDNESS, STONE_RESISTANCE, SoundType.STONE);
    ...
    public static final BlockSlab CRIMSON_SLAB_HALF = new BlockHalfSlab("crimson_slab_half", Material.GROUND, CreativeTabs.BUILDING_BLOCKS, ModBlocks.CRIMSON_SLAB_HALF, WOOD_HARDNESS, WOOD_RESISTANCE, SoundType.WOOD).setHarvestInfo("axe", 0);
    ...
    public static final BlockSlab WARPED_SLAB_HALF = new BlockHalfSlab("warped_slab_half", Material.GROUND, CreativeTabs.BUILDING_BLOCKS, ModBlocks.WARPED_SLAB_HALF, WOOD_HARDNESS, WOOD_RESISTANCE, SoundType.WOOD).setHarvestInfo("axe", 0);
