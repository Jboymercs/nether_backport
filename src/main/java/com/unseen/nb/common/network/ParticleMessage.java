package com.unseen.nb.common.network;
...
public class ParticleMessage implements IMessage
{
    ...
    public ParticleMessage(int particleId, double posX, double posY, double posZ, double speedX, double speedY, double speedZ, int... parameters)
    {
